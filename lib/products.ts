export const products = [
  ...
  {
    id: 4,
    name: "Planner Finanças💸 (Notion)",
    slug: "planner-financas-notion",
    category: ["Templates", "Planners"],
    price: 11.11,
    mainImage: "/financasNotion1.png",
    features: [
      "Controle de orçamentos, entradas e gastos",
      "Cálculos e correlações automáticos",
      "Definição de metas e gestão de orçamento",
      "Acompanhamento dos seus investimentos por valor, tipo e retorno",
    ],
    description:
